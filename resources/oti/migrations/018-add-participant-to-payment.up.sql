ALTER TABLE payment
  ADD COLUMN participant_id BIGINT REFERENCES participant(id),
  ALTER registration_id DROP NOT NULL;

UPDATE payment p SET participant_id = r.participant_id
FROM registration r
WHERE p.registration_id = r.id;

ALTER TABLE payment
  ALTER participant_id SET NOT NULL;
